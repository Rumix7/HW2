...
public class TaskListContent {
    ...
    static {
        ...
        addItem (new Task (String.valueOf(4),"Star Wars", "George Lucas", "1977"));
        addItem (new Task (String.valueOf(4),"Titanic", "James Cameron", "1997"));
        addItem (new Task (String.valueOf(4),"Jak rozpętałem drugą wojnę światową", "Tadeusz Chmielewski", "1970"));
